...
const referance_contact = (req, res) => {
...
const update_basic_details = (req, res) => {
...
const update_education = (req, res) => {
...
const update_work_experience = (req, res) => {
    try {
        console.log(req.body.id);
...
const update_language_known = (req, res) => {
...
const update_tech_known = (req, res) => {
...
const update_referance_contact = (req, res) => {
...
const update_preferances = (req, res) => {
    try {
...
module.exports = {jobapplicationajax,basic_details,education,work_experience,language_known,tech_known,referance_contact,preferances,candidates,candidate,update_basic_details,update_education,update_work_experience,update_language_known,update_tech_known,update_referance_contact,update_preferances,getcity}